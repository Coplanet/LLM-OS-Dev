...
example_agent_storage = PgAgentStorage(
    table_name="example_agent_sessions", db_url=db_url
)
...
def get_example_agent(
    ...
    return Agent(
        ...
        description=(
            "You are a highly advanced AI agent with access to an extensive "
            "knowledge base and powerful web-search capabilities."
        ),
        ...
        instructions=[
            ...
            "  - If the information is not available in your knowledge base, use `duckduckgo_search` "
            ...
            "  - If a user's request is unclear or incomplete, ask specific questions "
